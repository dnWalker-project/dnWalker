...
namespace dnWalker.Tests.ExampleTests
{
    ...
    {
#if TEST_DEBUG_MODE
        protected const string ExamplesAssemblyFileFormat = @"..\..\..\..\Examples\bin\Debug\framework\Examples.Framework.exe";
#elif TEST_RELEASE_MODE
        protected const string ExamplesAssemblyFileFormat = @"..\..\..\..\Examples\bin\Release\framework\Examples.Framework.exe";
#else
#error "Expected TEST_DEBUG_MODE or TEST_RELEASE_MODE defined!"
#endif
