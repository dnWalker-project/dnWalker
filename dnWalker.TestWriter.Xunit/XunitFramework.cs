...
namespace dnWalker.TestWriter.Xunit
{
    ...
    [AddPackage("xunit.runner.visualstudio", Version = "2.4.5", IncludeAssets = new[] { "runtime", "build", "native", "contentfiles", "analyzers", "buildtransitive" }, PrivateAssets = "all")]
    [AddPackage("coverlet.collector", Version = "3.2.0", IncludeAssets = new[] {"runtime", "build", "native", "contentfiles", "analyzers", "buildtransitive"}, PrivateAssets = "all")]
