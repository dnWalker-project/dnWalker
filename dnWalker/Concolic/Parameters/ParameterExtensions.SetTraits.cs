...
namespace dnWalker.Concolic.Parameters
{
    ...
    {        
        ...
        //{
        //    if (fullParameterName == parameter.FullName())
        //    {
        ...
        //    String accessor = ParameterName.GetAccessor(objectParameter.FullName(), fullParameterName);

        //    // IsNull
        //    if (accessor == ReferenceTypeParameter.IsNullName)
        //    {
        ...
        //        {
        //            String nextParamterName = ParameterName.ConstructField(objectParameter.FullName(), accessor);
