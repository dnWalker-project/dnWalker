...
namespace dnWalker.Tests.Concolic.Parameters
{
    public class NumericParametersTests : dnlibTypeTestBase
    {
        ...
        //[Fact]
        //public void Before_SettingValue_ValueTrait_IsNotAvailable_For_BooleanParameter()
        //{
        //    BooleanParameter p = new BooleanParameter();

        //    p.Traits.Count.Should().Be(0);
        //    p.TryGetTrait(out ValueTrait<Boolean> trait).Should().BeFalse();
        //}
        
        //[Fact]
        //public void Before_SettingValue_ValueTrait_IsNotAvailable_For_CharParameter()
        //{
        //    CharParameter p = new CharParameter();

        //    p.Traits.Count.Should().Be(0);
        //    p.TryGetTrait(out ValueTrait<Char> trait).Should().BeFalse();
        //}

        //[Fact]
        //public void Before_SettingValue_ValueTrait_IsNotAvailable_For_ByteParameter()
        //{
        //    ByteParameter p = new ByteParameter();

        //    p.Traits.Count.Should().Be(0);
        //    p.TryGetTrait(out ValueTrait<Byte> trait).Should().BeFalse();
        //}

        //[Fact]
        //public void Before_SettingValue_ValueTrait_IsNotAvailable_For_SByteParameter()
        //{
        //    SByteParameter p = new SByteParameter();

        //    p.Traits.Count.Should().Be(0);
        //    p.TryGetTrait(out ValueTrait<SByte> trait).Should().BeFalse();
        //}

        //[Fact]
        //public void Before_SettingValue_ValueTrait_IsNotAvailable_For_Int16Parameter()
        //{
        //    Int16Parameter p = new Int16Parameter();

        //    p.Traits.Count.Should().Be(0);
        //    p.TryGetTrait(out ValueTrait<Int16> trait).Should().BeFalse();
        //}

        //[Fact]
        //public void Before_SettingValue_ValueTrait_IsNotAvailable_For_Int32Parameter()
        //{
        //    Int32Parameter p = new Int32Parameter();

        //    p.Traits.Count.Should().Be(0);
        //    p.TryGetTrait(out ValueTrait<Int32> trait).Should().BeFalse();
        //}

        //[Fact]
        //public void Before_SettingValue_ValueTrait_IsNotAvailable_For_Int64Parameter()
        //{
        //    Int64Parameter p = new Int64Parameter();

        //    p.Traits.Count.Should().Be(0);
        //    p.TryGetTrait(out ValueTrait<Int64> trait).Should().BeFalse();
        //}

        //[Fact]
        //public void Before_SettingValue_ValueTrait_IsNotAvailable_For_UInt16Parameter()
        //{
        //    UInt16Parameter p = new UInt16Parameter();

        //    p.Traits.Count.Should().Be(0);
        //    p.TryGetTrait(out ValueTrait<UInt16> trait).Should().BeFalse();
        //}

        //[Fact]
        //public void Before_SettingValue_ValueTrait_IsNotAvailable_For_UInt32Parameter()
        //{
        //    UInt32Parameter p = new UInt32Parameter();

        //    p.Traits.Count.Should().Be(0);
        //    p.TryGetTrait(out ValueTrait<UInt32> trait).Should().BeFalse();
        //}

        //[Fact]
        //public void Before_SettingValue_ValueTrait_IsNotAvailable_For_UInt64Parameter()
        //{
        //    UInt64Parameter p = new UInt64Parameter();

        //    p.Traits.Count.Should().Be(0);
        //    p.TryGetTrait(out ValueTrait<UInt64> trait).Should().BeFalse();
        //}

        //[Fact]
        //public void Before_SettingValue_ValueTrait_IsNotAvailable_For_SingleParameter()
        //{
        //    SingleParameter p = new SingleParameter();

        //    p.Traits.Count.Should().Be(0);
        //    p.TryGetTrait(out ValueTrait<Single> trait).Should().BeFalse();
        //}

        //[Fact]
        //public void Before_SettingValue_ValueTrait_IsNotAvailable_For_DoubleParameter()
        //{
        //    DoubleParameter p = new DoubleParameter();

        //    p.Traits.Count.Should().Be(0);
        //    p.TryGetTrait(out ValueTrait<Double> trait).Should().BeFalse();
        //}
        ...
        [Fact]
        public void Before_SettingValue_Value_Is_Default_For_BooleanParameter()
        {
            BooleanParameter p = new BooleanParameter();
        ...
        [Fact]
        public void Before_SettingValue_Value_Is_Default_For_CharParameter()
        {
            CharParameter p = new CharParameter();
        ...
        [Fact]
        public void Before_SettingValue_Value_Is_Default_For_ByteParameter()
        {
            ByteParameter p = new ByteParameter();
        ...
        [Fact]
        public void Before_SettingValue_Value_Is_Default_For_SByteParameter()
        {
            SByteParameter p = new SByteParameter();
        ...
        [Fact]
        public void Before_SettingValue_Value_Is_Default_For_Int16Parameter()
        {
            Int16Parameter p = new Int16Parameter();
        ...
        [Fact]
        public void Before_SettingValue_Value_Is_Default_For_Int32Parameter()
        {
            Int32Parameter p = new Int32Parameter();
        ...
        [Fact]
        public void Before_SettingValue_Value_Is_Default_For_Int64Parameter()
        {
            Int64Parameter p = new Int64Parameter();
        ...
        [Fact]
        public void Before_SettingValue_Value_Is_Default_For_UInt16Parameter()
        {
            UInt16Parameter p = new UInt16Parameter();
        ...
        [Fact]
        public void Before_SettingValue_Value_Is_Default_For_UInt32Parameter()
        {
            UInt32Parameter p = new UInt32Parameter();
        ...
        [Fact]
        public void Before_SettingValue_Value_Is_Default_For_UInt64Parameter()
        {
            UInt64Parameter p = new UInt64Parameter();
        ...
        [Fact]
        public void Before_SettingValue_Value_Is_Default_For_SingleParameter()
        {
            SingleParameter p = new SingleParameter();
        ...
        [Fact]
        public void Before_SettingValue_Value_Is_Default_For_DoubleParameter()
        {
            DoubleParameter p = new DoubleParameter();
