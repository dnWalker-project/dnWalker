...
{
    public class BranchingTests : DebugExamplesTestBase
    {
        ...
        public void Test_Branch_Equals_TruePathFirst()
        {
            ...
            String[] pathConstraints = pathStore.Paths.Select(p => p.GetConstraintStringWithAccesses(store.BaseSet)).ToArray();
