...
namespace dnWalker.Tests.Parameters
{
    ...
    // {
        ...
        // {
        //     IParameterContext ctx = new ParameterContext(DefinitionProvider);
        //     IParameterSet set = new ParameterSet(ctx);
        //     IParameter p = set.CreateParameter(GetType("System.Boolean"));
        ...
        //     IParameterContext ctx = new ParameterContext(DefinitionProvider);
        //     IParameterSet set = new ParameterSet(ctx);
        //     IParameter p = set.CreateParameter(GetType("System.Char"));
        ...
        //     IParameterContext ctx = new ParameterContext(DefinitionProvider);
        //     IParameterSet set = new ParameterSet(ctx);
        //     IParameter p = set.CreateParameter(GetType("System.Byte"));
        ...
        //     IParameterContext ctx = new ParameterContext(DefinitionProvider);
        //     IParameterSet set = new ParameterSet(ctx);
        //     IParameter p = set.CreateParameter(GetType("System.SByte"));
        ...
        //     IParameterContext ctx = new ParameterContext(DefinitionProvider);
        //     IParameterSet set = new ParameterSet(ctx);
        //     IParameter p = set.CreateParameter(GetType("System.Int16"));
        ...
        //     IParameterContext ctx = new ParameterContext(DefinitionProvider);
        //     IParameterSet set = new ParameterSet(ctx);
        //     IParameter p = set.CreateParameter(GetType("System.Int32"));
        ...
        //     IParameterContext ctx = new ParameterContext(DefinitionProvider);
        //     IParameterSet set = new ParameterSet(ctx);
        //     IParameter p = set.CreateParameter(GetType("System.Int64"));
        ...
        //     IParameterContext ctx = new ParameterContext(DefinitionProvider);
        //     IParameterSet set = new ParameterSet(ctx);
        //     IParameter p = set.CreateParameter(GetType("System.UInt16"));
        ...
        //     IParameterContext ctx = new ParameterContext(DefinitionProvider);
        //     IParameterSet set = new ParameterSet(ctx);
        //     IParameter p = set.CreateParameter(GetType("System.UInt32"));
        ...
        //     IParameterContext ctx = new ParameterContext(DefinitionProvider);
        //     IParameterSet set = new ParameterSet(ctx);
        //     IParameter p = set.CreateParameter(GetType("System.UInt64"));
        ...
        //     IParameterContext ctx = new ParameterContext(DefinitionProvider);
        //     IParameterSet set = new ParameterSet(ctx);
        //     IParameter p = set.CreateParameter(GetType("System.Single"));
        ...
        //     IParameterContext ctx = new ParameterContext(DefinitionProvider);
        //     IParameterSet set = new ParameterSet(ctx);
        //     IParameter p = set.CreateParameter(GetType("System.Double"));
