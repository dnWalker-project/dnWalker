...
{
	public class MethodsWithArrayParameter_Tests_BranchIfNotNull
	{
		#region Test Methods
		...
		public void Test_Iteration_1()
		{
			...
			System.Int32[]? var_0x00000009 = null;
			...
			Examples.Concolic.Features.Arrays.MethodsWithArrayParameter.BranchIfNotNull(var_0x00000009);
		}
		...
		public void Test_Iteration_2()
		{
			// construct all parameters which are used in the test
			// TODO: construct return value comparer instance
			System.Int32[]? var_0x00000009 = Create_0x00000009(0);
		...
		private System.Int32[] Create_0x00000009(int length)
		{
		...
		// - instance
		private void Initialize_0x00000009(System.Int32[] array, params System.Int32[] items)
		{
